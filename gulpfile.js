...
gulp.task('js', function(){
    return concat({
        'frameworks.js': ['src/js/jquery.min.js','src/js/popper.min.js','src/css/bootstrap/js/bootstrap.min.js','src/js/magnific-popup/jquery.magnific-popup.js'],
        'main.js': ['src/js/main.js','src/js/jquery.validate.js','src/js/jquery.mask.min.js','src/js/js.cookie.min.js','src/js/envia.js']
        })
        .pipe(uglify())
...
gulp.task('clean', function () {
  return del(['dist/css/**/*','!dist/css/fonts/**','!dist/css/frameworks.css','!dist/css/style.css','!dist/css/icons.woff','!dist/css/fonts',
              'dist/js/**/*','!dist/js/frameworks.js','!dist/js/main.js']);
});
